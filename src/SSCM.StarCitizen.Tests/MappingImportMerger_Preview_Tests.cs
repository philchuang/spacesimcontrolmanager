...
public class MappingImportMerger_Preview_Tests : MappingImportMerger_TestBase
{
    ...
    public void Detects_Inputs_Removed_NotPreserved()
    {
        ...
        AssertSC.AreEqual(new MappingMergeAction(MappingMergeActionMode.Remove, this._current.Inputs[1]), this._merger.ResultSC.MergeActions[0]);
        AssertSC.AreEqual(new MappingMergeAction(MappingMergeActionMode.Remove, this._current.Mappings[0]), this._merger.ResultSC.MergeActions[1]);
    }
    ...
    public void Detects_InputSettings_Added()
    {
        ...
        Assert.IsTrue(this._merger.ResultSC.CanMerge);
        Assert.AreEqual(1, this._merger.ResultSC.MergeActions.Count);
        AssertSC.AreEqual(new MappingMergeAction(MappingMergeActionMode.Add, updatedInput.Settings[0]), this._merger.ResultSC.MergeActions[0]);
    }
    ...
    public void Detects_InputSettings_Removed_NotPreserved()
    {
        ...
        Assert.IsTrue(this._merger.ResultSC.CanMerge);
        Assert.AreEqual(1, this._merger.ResultSC.MergeActions.Count);
        AssertSC.AreEqual(new MappingMergeAction(MappingMergeActionMode.Remove, currentInput.Settings[0]), this._merger.ResultSC.MergeActions[0]);
    }
    ...
    public void Detects_InputSettings_Changed_NotPreserved()
    {
        ...
        Assert.IsTrue(this._merger.ResultSC.CanMerge);
        Assert.AreEqual(1, this._merger.ResultSC.MergeActions.Count);
        AssertSC.AreEqual(new MappingMergeAction(MappingMergeActionMode.Replace, updatedInput.Settings[0]), this._merger.ResultSC.MergeActions[0]);
    }
    ...
    public void Detects_Mapping_Added()
    {
        ...
        Assert.IsTrue(this._merger.ResultSC.CanMerge);
        Assert.AreEqual(1, this._merger.ResultSC.MergeActions.Count);
        AssertSC.AreEqual(new MappingMergeAction(MappingMergeActionMode.Add, addedMapping), this._merger.ResultSC.MergeActions[0]);
    }
    ...
    public void Detects_Mapping_Removed_NotPreserved()
    {
        ...
        Assert.IsTrue(this._merger.ResultSC.CanMerge);
        Assert.AreEqual(1, this._merger.ResultSC.MergeActions.Count);
        AssertSC.AreEqual(new MappingMergeAction(MappingMergeActionMode.Remove, removedMapping), this._merger.ResultSC.MergeActions[0]);
    }
    ...
    public void Detects_Mapping_Changed_NotPreserved()
    {
        ...
        Assert.IsTrue(this._merger.ResultSC.CanMerge);
        Assert.AreEqual(1, this._merger.ResultSC.MergeActions.Count);
        AssertSC.AreEqual(new MappingMergeAction(MappingMergeActionMode.Replace, changedMapping), this._merger.ResultSC.MergeActions[0]);
    }
    ...
    public void Creates_Merge_Actions()
    {
        ...
        AssertSC.AreEqual(new MappingMergeAction(MappingMergeActionMode.Add, addedInput), this._merger.ResultSC.MergeActions[++mergeActionsIdx]);

        Assert.AreEqual(1, this._merger.ResultSC.InputDiffs.Removed.Count);
        AssertSC.AreEqual(removedInput, this._merger.ResultSC.InputDiffs.Removed[0]);
        AssertSC.AreEqual(new MappingMergeAction(MappingMergeActionMode.Remove, removedInput), this._merger.ResultSC.MergeActions[++mergeActionsIdx]);
        ...
        AssertSC.AreEqual(new MappingMergeAction(MappingMergeActionMode.Add, addedSetting), this._merger.ResultSC.MergeActions[++mergeActionsIdx]);
        AssertSC.AreEqual(new MappingMergeAction(MappingMergeActionMode.Remove, removedSetting), this._merger.ResultSC.MergeActions[++mergeActionsIdx]);
        AssertSC.AreEqual(new MappingMergeAction(MappingMergeActionMode.Replace, updatedChangingSetting), this._merger.ResultSC.MergeActions[++mergeActionsIdx]);

        Assert.AreEqual(1, this._merger.ResultSC.MappingDiffs.Added.Count);
        AssertSC.AreEqual(addedMapping, this._merger.ResultSC.MappingDiffs.Added[0]);
        AssertSC.AreEqual(new MappingMergeAction(MappingMergeActionMode.Add, addedMapping), this._merger.ResultSC.MergeActions[++mergeActionsIdx]);
        ...
        AssertSC.AreEqual(new MappingMergeAction(MappingMergeActionMode.Remove, removedMapping), this._merger.ResultSC.MergeActions[++mergeActionsIdx]);
        ...
        AssertSC.AreEqual(new MappingMergeAction(MappingMergeActionMode.Replace, updatedChangedMapping), this._merger.ResultSC.MergeActions[++mergeActionsIdx]);
